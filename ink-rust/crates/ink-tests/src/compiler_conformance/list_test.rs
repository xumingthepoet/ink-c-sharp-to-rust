...
fn list_basic_operations_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/basic-operations.ink");
...
fn list_mixed_items_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/list-mixed-items.ink");
    let mut story = Story::new(&json_string);
...
fn more_list_operations_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/more-list-operations.ink");
    let mut story = Story::new(&json_string);
...
fn empty_list_origin_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/empty-list-origin.ink");
    let mut story = Story::new(&json_string);
...
fn list_save_load_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/list-save-load.ink");
    let mut story = Story::new(&json_string);
...
fn empty_list_origin_after_assinment_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_ink_string("inkfiles/lists/empty-list-origin-after-assignment.ink");
    let mut story = Story::new(&json_string);
...
fn list_range_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/list-range.ink");
    let mut story = Story::new(&json_string);
...
fn list_bug_adding_element_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/bug-adding-element.ink");
    let mut story = Story::new(&json_string);
...
fn more_list_operations2_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/more-list-operations2.ink");
    let mut story = Story::new(&json_string);
...
fn list_all_bug_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/list-all.ink");
    let mut story = Story::new(&json_string);
...
fn list_comparison_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/lists/list-comparison.ink");
    let mut story = Story::new(&json_string);
