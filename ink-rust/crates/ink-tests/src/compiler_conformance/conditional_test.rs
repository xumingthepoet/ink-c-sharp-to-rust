...
fn iftrue_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/iftrue.ink");
...
fn iffalse_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/iffalse.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/ifelse.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/ifelse-ext.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_text1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/ifelse-ext-text1.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_text2_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/ifelse-ext-text2.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
...
fn ifelse_ext_text3_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/ifelse-ext-text3.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
...
fn cond_text1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/condtext.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn cond_opt1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/condopt.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn stopping_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/stopping.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn cycle_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/cycle.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn once_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/once.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/shuffle.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_stopping() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/shuffle_stopping.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn shuffle_once() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/shuffle_once.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/multiline.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/multiline-divert.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
...
fn multiline_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/conditional/multiline-choice.ink");
    let mut story = Story::new(&json_string);
    println!("{}", story.build_string_of_hierarchy());
    let mut text: Vec<String> = Vec::new();
