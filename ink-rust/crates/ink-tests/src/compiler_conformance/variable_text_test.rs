...
fn sequence_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variabletext/sequence.ink");
...
fn cycle_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variabletext/cycle.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn once_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variabletext/once.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn empty_elements_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variabletext/empty-elements.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn list_in_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variabletext/list-in-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
