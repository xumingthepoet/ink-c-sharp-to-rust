...
fn single_choice1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/single-choice.ink");
...
fn suppress_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/suppress-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn mixed_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/mixed-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn varying_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/varying-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn sticky_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/sticky-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn fallback_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/fallback-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn conditional_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/conditional-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn label_flow_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/label-flow.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn label_scope_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/label-scope.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn divert_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/choices/divert-choice.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
