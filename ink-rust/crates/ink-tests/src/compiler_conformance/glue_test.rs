...
fn simple_glue_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/glue/simple-glue.ink");
...
fn glue_with_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/glue/glue-with-divert.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn has_left_right_glue_matching_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/glue/left-right-glue-matching.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn bugfix1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/glue/testbugfix1.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn bugfix2_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/glue/testbugfix2.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
