...
fn external_function() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/external-function-2-arg.ink");
...
fn external_function_zero_arguments() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/external-function-0-arg.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn external_function_one_arguments() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/external-function-1-arg.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn variable_observers_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/variable-observers.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn set_and_get_variable_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/set-get-variables.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn jump_knot_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/jump-knot.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn jump_stitch_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/jump-stitch.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn read_visit_counts_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/read-visit-counts.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn load_save_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/runtime/load-save.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
