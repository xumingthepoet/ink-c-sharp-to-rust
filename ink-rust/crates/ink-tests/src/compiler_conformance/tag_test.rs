...
fn tags_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/tags/tags.ink");
...
fn tags_in_seq_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/tags/tagsInSeq.ink");
    let mut story = Story::new(&json_string);
...
fn tags_in_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/tags/tagsInChoice.ink");
    let mut story = Story::new(&json_string);
...
fn tags_in_choice_dynamic_content_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/tags/tagsInChoiceDynamic.ink");
    let mut story = Story::new(&json_string);
...
fn tags_dynamic_content_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/tags/tagsDynamicContent.ink");
    let mut story = Story::new(&json_string);
