...
fn variable_declaration_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variable/variable-declaration.ink");
...
fn var_calc_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variable/varcalc.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn var_string_ink_bug_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variable/varstringinc.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn var_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/variable/var-divert.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
