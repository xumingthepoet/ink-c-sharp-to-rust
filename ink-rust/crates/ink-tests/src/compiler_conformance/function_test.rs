...
fn fun_basic_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/func-basic.ink");
...
fn fun_none_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/func-none.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn fun_inline_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/func-inline.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn setvar_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/setvar-func.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/complex-func1.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func2_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/complex-func2.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn complex_func3_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/complex-func3.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn rnd() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/function/rnd-func.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
    common::next_all(&mut story, &mut text);
...
fn evaluating_function_variable_state_bug_test() -> Result<(), StoryError> {
    let json_string =
        common::get_ink_string("inkfiles/function/evaluating-function-variablestate-bug.ink");
    let mut story = Story::new(&json_string);
