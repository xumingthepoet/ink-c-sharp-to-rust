...
fn gather_basic_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/gather/gather-basic.ink");
...
fn gather_chain_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/gather/gather-chain.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn nested_flow_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/gather/nested-flow.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn deep_nesting_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/gather/deep-nesting.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
...
fn complex_flow1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/gather/complex-flow.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
