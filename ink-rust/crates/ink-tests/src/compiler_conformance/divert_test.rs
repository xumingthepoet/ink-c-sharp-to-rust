...
fn simple_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/divert/simple-divert.ink");
...
fn invisible_divert_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/divert/invisible-divert.ink");
    let mut story = Story::new(&json_string);
...
fn divert_on_choice_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/divert/divert-on-choice.ink");
    let mut story = Story::new(&json_string);
...
fn complex_branching1_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/divert/complex-branching.ink");
    let mut story = Story::new(&json_string);
    let mut text: Vec<String> = Vec::new();
