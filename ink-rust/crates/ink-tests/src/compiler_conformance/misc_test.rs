...
fn operations_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/misc/operations.ink");
...
fn read_counts_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/misc/read-counts.ink");
    let mut story = Story::new(&json_string);
...
fn turns_since_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/misc/turns-since.ink");
    let mut story = Story::new(&json_string);
...
fn issue15_test() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/misc/issue15.ink");
    let mut story = Story::new(&json_string);
...
fn newlines_with_string_eval_test() -> Result<(), Box<dyn Error>> {
    let json_string = common::get_ink_string("inkfiles/misc/newlines_with_string_eval.ink");
    let mut story = Story::new(&json_string);
...
fn i18n() -> Result<(), StoryError> {
    let json_string = common::get_ink_string("inkfiles/misc/i18n.ink");
    let mut story = Story::new(&json_string);
